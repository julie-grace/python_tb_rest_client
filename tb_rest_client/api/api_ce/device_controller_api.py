...
class DeviceControllerApi(object):
    ...
    def find_by_query_using_post1_with_http_info(self, query, **kwargs):  # noqa: E501
        ...
        if ('query' not in params or
            ...
            raise ValueError("Missing the required parameter `query` when calling `find_by_query_using_post1`")  # noqa: E501
    ...
    def get_tenant_device_profiles_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        """getTenantDevices  # noqa: E501
    ...
    def save_device_credentials_using_post_with_http_info(self, device_credentials, **kwargs):  # noqa: E501
        ...
        if ('device_credentials' not in params or
            ...
            raise ValueError("Missing the required parameter `device_credentials` when calling `save_device_credentials_using_post`")  # noqa: E501
